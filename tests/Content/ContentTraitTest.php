...
final class ContentTraitTest extends TestCase
{
    ...
    public function testSlugPropertyHasValidationConstraints(): void
    {
        ...
        // Slug is auto-generated by SlugGeneratorListener from the entity's source
        // field (#[SlugSource] property or getTitle()) when not provided, so NotBlank
        // is intentionally absent. Length + Regex still validate any explicit value.
        $this->assertNotContains(Assert\NotBlank::class, $attributeNames, 'Slug should not be NotBlank — auto-generated on persist');
